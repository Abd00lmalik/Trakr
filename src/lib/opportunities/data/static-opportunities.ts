...
const staticOpportunityCatalog: StaticOpportunity[] = [
  ...
  },
  {
    ...
    summary:
      "Official developer community and learning resources for students building technical portfolios. This is not a scholarship or funded award.",
    ...
    tags: ["student", "developer education", "learning resource"],
    difficulty: "low",
  },
  {
