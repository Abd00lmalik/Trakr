...
export function compactProfileForSession(
  ...
  return {
    ...
    fieldOfStudy: compactText(profile.fieldOfStudy, 160),
    currentDegreeLevel: compactText(profile.currentDegreeLevel, 80),
    targetDegreeLevel: compactText(profile.targetDegreeLevel, 80),
    currentInstitution: compactText(profile.currentInstitution, 200),
    graduationYear: compactText(profile.graduationYear, 16),
    nationality: compactText(profile.nationality, 100),
    countryOfResidence: compactText(profile.countryOfResidence, 120),
    preferredStudyCountries: compactList(
    ...
    intendedStartYear: compactText(profile.intendedStartYear, 16),
    fundingRequirement: compactText(profile.fundingRequirement, 160),
    languageTestStatus: compactText(profile.languageTestStatus, 160),
    workAuthorization: compactText(profile.workAuthorization, 200),
    sponsorshipRequired: profile.sponsorshipRequired,
    availability: compactText(profile.availability, 160),
